...
>Important Notice: Break periods and lunch hours vary by day and are not consistent. Please verify the specific times for each date.
...
| | 10:40-11:00 | <span class=talk>ProofTeller: Exposing Recency Bias in LLM Reasoning and Its Side Effects on Communication (Extended Abstract)</span> Mayank Jobanputra, Alisa Kovtunova, Brisca Balthes, Fedor Grigoryevich Pogulskiy, Yifan Wang, Stefan Borgwardt, Vera Demberg |
| | 11:00-11:20 | <span class=talk>The More the Merrier: Combining Properties for ABox Abduction under Repair Semantics for ℰℒ<sub>⊥</sub></span> Anselm Haak, Patrick Koopmann, Yasir Mahmood, Anni-Yasmin Turhan  |
| | 11:20-11:40 | <span class=talk>In the Heart of the Beholder: User-Tailored Explanations for Description Logics</span> Stefan Borgwardt, Anke Hirsch, Nina Knieriemen, Alisa Kovtunova  |
